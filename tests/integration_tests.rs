...
mod tests {
    ...
    use lau_representation_theory::group::FiniteGroup;
    use lau_representation_theory::representation::Representation;
    use lau_representation_theory::character::{Character, CharacterTable};
    use lau_representation_theory::irreducible::{is_irreducible, schur_lemma, isotypic_projection};
    use lau_representation_theory::decomposition::{decompose, verify_maschke};
    use lau_representation_theory::induced::{
    ...
    use lau_representation_theory::tensor::{
    ...
    use lau_representation_theory::young::{YoungDiagram, YoungTableau, symmetric_group_character};
    use lau_representation_theory::agent_symmetry::{
